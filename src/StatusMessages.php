...
final class StatusMessages
{
    ...
    public const MESSAGES_EN = [
        'evatr-0000' => ['category' => 'Result', 'httpCode' => 200, 'field' => null, 'message' => 'The requested VAT ID is valid at the time of the request.'],
        ...
        'evatr-0004' => ['category' => 'Error', 'httpCode' => 400, 'field' => 'vatIdOwn', 'message' => 'The requesting German VAT ID is syntactically invalid. It does not match the German generation scheme.'],
        ...
        'evatr-0012' => ['category' => 'Error', 'httpCode' => 400, 'field' => 'vatIdForeign', 'message' => 'The requested VAT ID is syntactically invalid. It does not match the generation scheme.'],
        ...
        'evatr-2001' => ['category' => 'Notice', 'httpCode' => 404, 'field' => 'vatIdForeign', 'message' => 'The requested VAT ID is not assigned at the time of the request.'],
        'evatr-2002' => ['category' => 'Notice', 'httpCode' => 200, 'field' => 'vatIdForeign', 'message' => 'The requested VAT ID is not valid at the time of the request. It will be valid starting from the date in validFrom.'],
        'evatr-2003' => ['category' => 'Error', 'httpCode' => 400, 'field' => 'vatIdForeign', 'message' => 'The specified country code of the requested VAT ID is not valid.'],
        ...
        'evatr-2006' => ['category' => 'Notice', 'httpCode' => 200, 'field' => 'vatIdForeign', 'message' => 'The requested VAT ID is not valid at the time of the request. It was valid during the period described by validFrom and validTill.'],
        ...
        'evatr-2008' => ['category' => 'Notice', 'httpCode' => 200, 'field' => null, 'message' => 'The requested VAT ID is valid at the time of the request. There is a particular condition for the qualified confirmation request. For inquiries, please contact the BZSt.'],
